                    ...
                    <div className="lg:pr-8 lg:pt-4">
                        <div className="lg:max-w-lg">
                            ...
                            <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                                ...
                                <div className="relative pl-9" data-aos="fade-right">
                                    ...
                                    </svg>   Increase Revenue </dt>
                                    <dd className="inline">  Ensure accurate claims submission and reduce denied or rejected claims, improving your overall financial performance.
                                    </dd>
                                </div>
                            </dl>
                        </div>
                        <div className="mt-10 flex items-center gap-x-6">
                            <Link href="/free-audit"
                                className="rounded-md bg-secondaryColor px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ">Get
                                free audit
                            </Link>

                        </div>
                    </div>
                    <img src="/medical_billing.png" alt="Product screenshot" className="w-[48rem] max-w-none sm:w-[57rem] md:-ml-4 lg:-ml-0" width="2432" height="1442" />
                </div>
            </div>
        </section>
    )
